...
public class StickyHeadContainer extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.d("setMeasuredDimension","desireWidth:"+desireWidth + ",widthMeasureSpec:"+widthMeasureSpec + ",desireHeight:" + desireHeight +",heightMeasureSpec:"+heightMeasureSpec);
        // 设置最终测量值
    ...
    public void scrollChild(int offset) {
        if (mLastOffset != offset) {
            mOffset = offset;
            Log.d("scrollChild","mOffset:"+mOffset + "mLastOffset:"+mLastOffset);
